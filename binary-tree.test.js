...
describe("minDepth", function() {
  ...
  it("handles more complex trees", function() {
    expect(largeTree.minDepth(largeTree.root)).toBe(2);
  });
...
describe("maxDepth", function() {
  it("handles simple trees", function() {
    expect(smallTree.maxDepth(smallTree.root)).toBe(2);
  });
...
describe("maxSum", function() {
  it("handles simple trees", function() {
    expect(smallTree.maxSum(smallTree.root)).toBe(16);
  });

  it("handles empty trees", function() {
    expect(emptyTree.maxSum(emptyTree.root)).toBe(0);
  });

  it("handles more complex trees", function() {
    expect(largeTree.maxSum(largeTree.root)).toBe(21);
  });
  ...
  it("handles negative values", function() {
    ...
    expect(tree.maxSum(tree.root)).toBe(119);
  });
});

describe("nextLarger", function() {
  it("handles simple trees", function() {
    expect(smallTree.nextLarger(smallTree.root, 4)).toBe(5);
    expect(smallTree.nextLarger(smallTree.root, 5)).toBe(6);
    expect(smallTree.nextLarger(smallTree.root, 6)).toBe(null);
  });

  it("handles empty trees", function() {
    expect(emptyTree.nextLarger(emptyTree.root, 0)).toBe(null);
  });

  it("handles more complex trees", function() {
    expect(largeTree.nextLarger(largeTree.root, 1)).toBe(2);
    expect(largeTree.nextLarger(largeTree.root, 2)).toBe(3);
    expect(largeTree.nextLarger(largeTree.root, 3)).toBe(5);
    expect(largeTree.nextLarger(largeTree.root, 4)).toBe(5);
    expect(largeTree.nextLarger(largeTree.root, 5)).toBe(6);
    expect(largeTree.nextLarger(largeTree.root, 6)).toBe(null);
  });
});
